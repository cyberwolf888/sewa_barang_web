...
@section('content')
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a href="{{ route('admin.category.manage') }}">Kategori</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">Kelola Kategori</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="{{ route('admin.category.create') }}" class="btn btn-circle green">
                            ...
                            @foreach($model as $row)
                                <tr>
                                    ...
                                    <td class="center" width="100">
                                        <a href="{{ route('admin.category.edit',$row->id) }}" class="btn yellow-saffron btn-xs"><i class="fa fa-pencil"></i></a>
                                    </td>
                                </tr>
                                <?php $no++ ?>
                            @endforeach
